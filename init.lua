...
require('lazy').setup({
  ...
  -- The LSP configuration is done below. Search for lspconfig to find it below.
  {
...
vim.keymap.set('n', '<leader>og', vim.cmd.GBrowse, { desc = '[O]pen in [G]itHub' })

-- [[ Configure Treesitter ]]
-- See `:help nvim-treesitter`
require('nvim-treesitter.configs').setup {
  -- Add languages to be installed here that you want installed for treesitter
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'toml', 'typescript', 'help', 'vim', 'fish' },
...
local common_on_attach = function(_, bufnr)
  ...
  -- Rust Tools
  -- Rust specific binds
  nmap('<leader>rh', require("rust-tools").hover_actions.hover_actions, '[R]ust [H]over Actions')
  nmap('<leader>rc', require("rust-tools").code_action_group.code_action_group, '[R]ust [C]ode Actions')
  nmap('<leader>rr', vim.cmd.RustRun, '[R]ust [R]un')
...
mason_lspconfig.setup {
  -- Automatically install the above servers
